...
var HereGeocoder = function HereGeocoder(httpAdapter, options) {
  this.options = ['appId', 'appCode', 'useCIT', 'language', 'politicalView', 'country', 'state'];
...
// Here geocoding API endpoint
HereGeocoder.prototype._geocodeCitEndpoint = 'https://geocoder.cit.api.here.com/6.2/geocode.json';

// Here reverse geocoding API endpoint
HereGeocoder.prototype._reverseCitEndpoint = 'https://reverse.geocoder.cit.api.here.com/6.2/reversegeocode.json';
...
HereGeocoder.prototype._geocode = function (value, callback) {
  ...
  if (value.address) {
    ...
    if (value.postalcode) {
      params.postalcode = value.postalcode;
    }
    if (value.housenumber) {
      params.housenumber = value.housenumber;
    }
  ...
  var endPoint = this.options.useCIT === true ? this._geocodeCitEndpoint : this._geocodeEndpoint;
...
HereGeocoder.prototype._reverse = function (query, callback) {
  ...
  var endPoint = this.options.useCIT === true ? this._reverseCitEndpoint : this._reverseEndpoint;
