...
var CustomNominatimGeocoder = require('./geocoder/customnominatimgeocoder.js');
...
var GeocoderFactory = {
  ...
  */
  _getGeocoder: function(geocoderName, adapter, extra) {
    ...
    if (geocoderName === 'customnominatim') {
      return new CustomNominatimGeocoder(adapter, {host: extra.host, port: extra.port});
    }	
